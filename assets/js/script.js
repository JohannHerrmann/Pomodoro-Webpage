(function () {
  ...
  function stopSound(unit,g){ if(duckingEl && duckingEl.value==='true'){ rampGain(g,0.0,0.8); setTimeout(()=>{try{unit.stop();}catch{} try{g.disconnect();}catch{}}, 850); } else { try{unit.stop();}catch{} try{g.disconnect();}catch{} } }
